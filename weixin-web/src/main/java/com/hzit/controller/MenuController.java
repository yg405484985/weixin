...
import com.hzit.entity.menu.MenuItem;
import com.hzit.entity.menu.MenuManage;
import com.hzit.entity.menu.MenuType;
import com.hzit.proxy.menu.WXProxyMenu;
...
public class MenuController {
	...
	public Object manageMuen() {
		String genMenuString = genMenuString();
		String menuManage = WXProxyMenu.menuManage(genMenuString);

		System.out.println("响应的结果:" + menuManage);
		return menuManage;
	}
